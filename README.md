...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-26 20:21`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a227a803-f237-4f94-ab7b-1cf872557a4e.git
$ cd a227a803-f237-4f94-ab7b-1cf872557a4e
```
